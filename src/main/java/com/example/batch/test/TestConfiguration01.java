...
public class TestConfiguration01 {
    private static final Logger log = LoggerFactory.getLogger(TestConfiguration01.class);
...
//        }});
    ...
    @Bean(name="testStep01")
    public Step step() {
        return stepBuilderFactory.get("testStep01")
                .<User, User> chunk(10)
                .reader(reader())
                .processor(processor)
                .writer(writer())
